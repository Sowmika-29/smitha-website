...
@Component({
  ...
  template: `
    <section class="ingredients" id="ingredients" #ingredientsSection>
      <div class="glass-blob blob-accent" style="top: 20%; right: -50px; opacity: 0.1;"></div>
      <div class="floating-leaf" style="top: 10%; left: 15%; animation-delay: -3s;">
        <svg width="50" height="50" viewBox="0 0 24 24" fill="currentColor"><path d="M17,8C8,10 5.9,16.17 3.82,21.34L5.71,22L6.66,19.7C7.14,19.87 7.64,20 8,20C19,20 22,3 22,3C21,5 14,5.25 9,6.25C4,7.25 2,11.5 2,13.5C2,15.5 3.75,17.25 3.75,17.25C7,8 17,8 17,8Z"/></svg>
      </div>
      <div class="floating-leaf" style="bottom: 10%; right: 15%; animation-delay: -10s; transform: scale(1.5) rotate(45deg);">
  ...
  ingredients: Ingredient[] = [
    {
      ...
      image: '/assets/images/hero-hibiscus.jpg'
    },
    {
      name: 'Shikakai',
      ...
      image: '/assets/images/hero-shikakai.jpg'
    },
    {
      ...
      image: '/assets/images/hero-herbal.jpg'
    }
  ];
